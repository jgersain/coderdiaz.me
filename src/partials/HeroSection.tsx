...
const HeroSection = () => {
  return (
    <section className="bg-darken relative overflow-hidden" style={{
      ...
      <div className="container px-4 md:px-8 lg:h-full lg:max-w-screen-xl mx-auto">
        <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-xl lg:py-56 lg:pr-4 lg:w-full lg:flex lg:items-center">
          <div className="mt-12 mx-auto px-4 sm:mt-16 sm:px-6 md:px-4 md:mt-16 lg:mt-0 lg:px-0 xl:mt-28">
            ...
            <div className="mt-6 flex lg:animation-delay-125 lg:animation-custom-cubic lg:animation-0.5s lg:animation-fill-both lg:animation-fadeInUp lg:animation-once">
      ...
      <div className="hero__image hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full lg:animation-clipOut lg:animation-delay-1.5s lg:animation-0.5s lg:animation-fill-both lg:animation-once">
        <picture>
          <source
            type="image/webp"
